(function () {
            ...
            messageItem.addEventListener('click', function () {
                ...
                httpRequestView.onload = function () {
                    if (httpRequestView.status === 200) {
                        ...
                        itemMessage.innerHTML = "<span>Message reçu le " + messageDate + " à : " + messageTime + "</span> <i class='bi bi-caret-right-fill message-chevron'></i>"
    ...
    function listenMessageContent() {
        ...
        btnRemoveMessage.onclick = (element) => {
            let confirmation = confirm('Êtes vous sûr de vouloir supprimer le message');
            if (confirmation) {
